...
export default function App() {
  ...
  // Функция для выполнения GET запроса к защищенному ресурсу с использованием токена
  async function getData() {
    try {
      // Выполняем GET запрос с заголовком Authorization, содержащим токен
...
<main className="form-signin w-100 m-auto">
  <form>
    <img className="mb-4" src="/docs/5.3/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"></img>
